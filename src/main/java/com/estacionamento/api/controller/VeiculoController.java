...
public class VeiculoController  {
	...
	public void CreateVeiculo(@Valid @RequestBody Veiculo veiculo, @PathVariable Long id) throws BussinesError {
		VeiculoServ.cadVeiculo.execute(veiculo, id);
	}
	
	@GetMapping("/{id}")
	public List<Veiculo> ListVeiculo(@PathVariable Long id) {
		return VeiculoServ.listVeiculo.execute(id);
	}
	
	@DeleteMapping("/{EstId}/{CarId}")
	public void DelVeiculo(@Valid @PathVariable Long EstId, @PathVariable Long CarId) throws BussinesError {
